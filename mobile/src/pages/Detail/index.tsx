...
import { StyleSheet, View, Image, Text, SafeAreaView, TouchableOpacity, Linking } from 'react-native';
...
const Detail = () => {
    ...
    return (
      <SafeAreaView style={{ flex: 1 }}>
        <View style={styles.container}>
          ...
          <Text style={styles.pointItems}>{data.item.map(items => items.title).join(', ')}</Text>
    ...
    <Text style={styles.addressContent}>{data.point.city}-{data.point.UF}</Text>
        ...
        <View style={styles.containerContact}>
          <Text style={styles.addressTitle}>Entre em contato</Text>
        </View>
